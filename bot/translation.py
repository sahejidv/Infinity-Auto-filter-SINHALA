#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# (c) @viha_is_power| @AlbertEinsteinTG | @Hillard_Har 
...
I am a filter bot with advanced features currenty workig for any group. මන් විහඟයගෙ බොටෙක් බන් එනව  මෙතන රෙද්දක් හොයන්  ,උබට ඕන්නම් එකක් හදා ගනින් පරයෝ   .
...
○ ᴄʀᴇᴀᴛᴏʀ : [vihanga](https://t.me/viha_is_power)

**[our group](https://t.me/joinchat/Q1uroGQ645U1OTg1)**
"""
